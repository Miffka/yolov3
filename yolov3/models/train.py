...
import yolov3.models.test as test  # import test.py to get mAP after each epoch
from yolov3.models.models import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default=osp.join(config.data_dir, 'coco.data'), help='*.data file path')
    ...
    parser.add_argument('--weights', type=str, default=osp.join(config.weights_dir, 'yolov3-spp.weights'), help='initial weights')  # i.e. weights/darknet.53.conv.74
